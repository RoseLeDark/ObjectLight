...
namespace OB {
    ...
    public:
        ...
        explicit MovebleObject(OB::uuid_t SubUUID) 
    ...
    class  PrintebleObject : public Object {
    public:
        using this_type = PrintebleObject;
        using base_type = Object;

        explicit PrintebleObject(OB::uuid_t SubUUID)
    ...
    public:
        ...
        explicit VisualObject(OB::uuid_t SubUUID)
    ...
    public:
		...
		explicit StringObject(std::string str, OB::uuid_t SubUUID)
    ...
    public:
		...
		explicit ValueObject(uint32_t value, OB::uuid_t SubUUID)
    ...
    public:
		...
		explicit FloatObject(float value, OB::uuid_t SubUUID)
    ...
    public:
		...
		explicit MessengerObject(OB::uuid_t SubUUID)
